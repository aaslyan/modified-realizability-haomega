...
too --- and the ordinals and hydra trees are now both out of $\Nat$ (above).
Hanoi never needed the treatment: its move sequences were functions from the
first version, which is what its encoding-wall experiment established.
