...
theorem Tm.rename_rename {Γ : List Ty} {τ : Ty} (t : Tm Γ τ) :
  ...
  | ezero => intros; rfl
  | orde a b iha ihb => intro Δ Θ ρ ρ'; simp only [Tm.rename, iha, ihb]
  | olte a b iha ihb => intro Δ Θ ρ ρ'; simp only [Tm.rename, iha, ihb]
  | tiRecE sc n ihs ihn => intro Δ Θ ρ ρ'; simp only [Tm.rename, ihs, ihn]
  | hleaf => intros; rfl
  ...
  | hcutAtH p a b ihp iha ihb =>
      intro Δ Θ ρ ρ'; simp only [Tm.rename, ihp, iha, ihb]
  | qnat a ih => intro Δ Θ ρ ρ'; simp only [Tm.rename, ih]
  | dnat a ih => intro Δ Θ ρ ρ'; simp only [Tm.rename, ih]
  | dhalf a ih => intro Δ Θ ρ ρ'; simp only [Tm.rename, ih]
  | dtoq a ih => intro Δ Θ ρ ρ'; simp only [Tm.rename, ih]
  | qadd a b iha ihb => intro Δ Θ ρ ρ'; simp only [Tm.rename, iha, ihb]
  | qsub a b iha ihb => intro Δ Θ ρ ρ'; simp only [Tm.rename, iha, ihb]
  | qmul a b iha ihb => intro Δ Θ ρ ρ'; simp only [Tm.rename, iha, ihb]
  | qdiv a b iha ihb => intro Δ Θ ρ ρ'; simp only [Tm.rename, iha, ihb]
  | qlt a b iha ihb => intro Δ Θ ρ ρ'; simp only [Tm.rename, iha, ihb]
  | dadd a b iha ihb => intro Δ Θ ρ ρ'; simp only [Tm.rename, iha, ihb]
  | dsub a b iha ihb => intro Δ Θ ρ ρ'; simp only [Tm.rename, iha, ihb]
  | dmul a b iha ihb => intro Δ Θ ρ ρ'; simp only [Tm.rename, iha, ihb]
  | dlt a b iha ihb => intro Δ Θ ρ ρ'; simp only [Tm.rename, iha, ihb]
...
theorem Tm.rename_subst {Γ : List Ty} {τ : Ty} (t : Tm Γ τ) :
  ...
  | ezero => intros; rfl
  | orde a b iha ihb => intro Δ Θ s ρ; simp only [Tm.subst, Tm.rename, iha, ihb]
  | olte a b iha ihb => intro Δ Θ s ρ; simp only [Tm.subst, Tm.rename, iha, ihb]
  | tiRecE sc n ihs ihn =>
      intro Δ Θ s ρ; simp only [Tm.subst, Tm.rename, ihs, ihn]
  | hleaf => intros; rfl
  ...
  | hcutAtH p a b ihp iha ihb =>
      intro Δ Θ s ρ; simp only [Tm.subst, Tm.rename, ihp, iha, ihb]
  | qnat a ih => intro Δ Θ s ρ; simp only [Tm.subst, Tm.rename, ih]
  | dnat a ih => intro Δ Θ s ρ; simp only [Tm.subst, Tm.rename, ih]
  | dhalf a ih => intro Δ Θ s ρ; simp only [Tm.subst, Tm.rename, ih]
  | dtoq a ih => intro Δ Θ s ρ; simp only [Tm.subst, Tm.rename, ih]
  | qadd a b iha ihb => intro Δ Θ s ρ; simp only [Tm.subst, Tm.rename, iha, ihb]
  | qsub a b iha ihb => intro Δ Θ s ρ; simp only [Tm.subst, Tm.rename, iha, ihb]
  | qmul a b iha ihb => intro Δ Θ s ρ; simp only [Tm.subst, Tm.rename, iha, ihb]
  | qdiv a b iha ihb => intro Δ Θ s ρ; simp only [Tm.subst, Tm.rename, iha, ihb]
  | qlt a b iha ihb => intro Δ Θ s ρ; simp only [Tm.subst, Tm.rename, iha, ihb]
  | dadd a b iha ihb => intro Δ Θ s ρ; simp only [Tm.subst, Tm.rename, iha, ihb]
  | dsub a b iha ihb => intro Δ Θ s ρ; simp only [Tm.subst, Tm.rename, iha, ihb]
  | dmul a b iha ihb => intro Δ Θ s ρ; simp only [Tm.subst, Tm.rename, iha, ihb]
  | dlt a b iha ihb => intro Δ Θ s ρ; simp only [Tm.subst, Tm.rename, iha, ihb]
